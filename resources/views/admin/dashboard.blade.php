                ...
                <div class="nav-right">
                    <ul class="header-right">
                        ...
                        <li> <a class="dark-mode" href="javascript:void(0)">
                                <svg>
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/assets/svg/iconly-sprite.svg#moondark">
                                    </use>
                                </svg></a></li>
                        <li class="custom-dropdown"><a href="javascript:void(0)">
                                <svg>
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/assets/svg/iconly-sprite.svg#cart-icon">
                                    </use>
                                ...
                                <ul class="pb-0">
                                    <li>
                                        <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60"
                                                src="/admin_assets/images/dashboard-2/1.png" alt="" />
                                    ...
                                    <li>
                                        <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60"
                                                src="/admin_assets/images/dashboard-2/2.png" alt="" />
                        ...
                        <li class="custom-dropdown"><a href="javascript:void(0)">
                                <svg>
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/assets/svg/iconly-sprite.svg#notification">
                                    </use>
                        ...
                        <li><a class="full-screen" href="javascript:void(0)">
                                <svg>
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/assets/svg/iconly-sprite.svg#scanfull">
                                    </use>
                                </svg></a></li>
                        <li class="custom-dropdown"><a href="javascript:void(0)">
                                <svg>
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/assets/svg/iconly-sprite.svg#bookmark">
                                    </use>
                                </svg></a>
                        ...
                        <li class="profile-nav custom-dropdown">
                            <div class="user-wrap">
                                <div class="user-img"><img src="/admin_assets/images/profile.png" alt="user" />
                                </div>
                ...
                <div class="main-sidebar" id="main-sidebar">
                    <ul class="sidebar-menu" id="simple-bar">
                        ...
                        <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/assets/svg/iconly-sprite.svg#Info-circle">
                                    </use>
                                </svg>
                        ...
                        <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/assets/svg/iconly-sprite.svg#Search-sidebar">
                                    </use>
                                </svg>
            ...
            <div class="page-body">
                ...
                <div class="container-fluid default-dashboard">
                    <div class="row">
                            ...
                            <div class="card welcome-banner">
                                <div class="card-header p-0 card-no-border">
                                    <div class="welcome-card"><img class="w-100 img-fluid"
                                            src="/admin_assets/images/dashboard-1/welcome-bg.png"
                                            alt="" /><img class="position-absolute img-1 img-fluid"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-center justify-content-between"><a
                                            class="btn btn-pill btn-primary" href="#">Whats New!</a><span>
                                            <svg class="stroke-icon">
                                                <use
                        ...
                        <div class="col-xxl-8 col-xl-6 proorder-xxl-7 col-lg-12 box-col-12">
                                        ...
                                        <li>
                                            <div class="d-flex gap-2">
                                                <div class="flex-shrink-0 bg-light-primary">
                                                    <svg class="stroke-icon">
                                                        <use
                                                            href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#job-bag">
                                                        </use>
                                                    </svg>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <li>
                                            <div class="d-flex gap-2">
                                                <div class="flex-shrink-0 bg-light-secondary">
                                                    <svg class="stroke-icon">
                                                        <use
                                                            href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#employees">
                                                        </use>
                                                    </svg>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <li>
                                            <div class="d-flex gap-2">
                                                <div class="flex-shrink-0 bg-light-warning">
                                                    <svg class="stroke-icon">
                                                        <use
                                                            href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#hours-work">
                                                        </use>
                                                    </svg>
                                                </div>
                                                <div class="flex-grow-1">
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="/admin_assets/images/dashboard-1/user/1.png"
                                                                    alt="" /></div>
                                                            <div class="flex-grow-1">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="/admin_assets/images/dashboard-1/user/2.png"
                                                                    alt="" /></div>
                                                            <div class="flex-grow-1">
                                                                <h6>Naomi watson</h6>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="flex-shrink-0"><img
                                                                    src="/admin_assets/images/dashboard-1/user/3.png"
                                                                    alt="" /></div>
                                                            <div class="flex-grow-1">
                                                                <h6>Dann Petty</h6>
                                                            </div>
                                    ...
                                    <ul>
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0 bg-success"><img
                                                    src="/admin_assets/images/dashboard-1/icon/checked.png"
                                                    alt="" /></div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0 bg-warning"><img
                                                    src="/admin_assets/images/dashboard-1/icon/danger.png"
                                                    alt="" /></div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0 bg-danger"><img
                                                    src="/admin_assets/images/dashboard-1/icon/cancel.png"
                                                    alt="" /></div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                            ...
                            <div class="card">
                                <div class="card-header card-no-border pb-0">
                                    <div class="header-top">
                                        ...
                                        <div class="dropdown icon-dropdown">
                                            <button class="btn" id="userdropdown6" type="button"
                                                data-bs-toggle="dropdown" aria-expanded="false"><i
                                                    class="fa-solid fa-ellipsis"></i></button>
                                            <div class="dropdown-menu dropdown-menu-end"
                                    ...
                                    <ul>
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                                <svg class="stroke-icon stroke-primary">
                                                    <use
                                                        href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#box">
                                                    </use>
                                                </svg>
                                            </div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0 bg-light-warning border-light-warning">
                                                <svg class="stroke-icon stroke-warning">
                                                    <use
                                                        href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#dolar">
                                                    </use>
                                                </svg>
                                            </div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0 bg-light-danger border-light-danger">
                                                <svg class="stroke-icon stroke-danger">
                                                    <use
                                                        href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#round-right">
                                                    </use>
                                                </svg>
                                            </div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                                <svg class="stroke-icon stroke-primary">
                                                    <use
                                                        href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#pie-chart">
                                                    </use>
                                                </svg>
                                            </div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0 bg-light-warning border-light-warning">
                                                <svg class="stroke-icon stroke-warning">
                                                    <use
                                                        href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#globe">
                                                    </use>
                                                </svg>
                                            </div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0 bg-light-danger border-light-danger">
                                                <svg class="stroke-icon stroke-none">
                                                    <use
                                                        href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#box-user">
                                                    </use>
                                                </svg>
                                            </div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                        ...
                                        <li class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0 bg-light-primary border-light-primary">
                                                <svg class="stroke-icon stroke-primary">
                                                    <use
                                                        href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#work-bag">
                                                    </use>
                                                </svg>
                                            </div>
                                            <div class="flex-grow-1"><a href="product-page.html">
                                ...
                                <div class="card-body top-user pt-2">
                                    <ul>
                                        <li class="d-flex align-items-center justify-content-between gap-2">
                                            <div class="d-flex gap-2">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="/admin_assets/images/dashboard-1/user/01.png"
                                                        alt="" /></div>
                                                <div><a href="#">
                                                        <h6>Alice Goodwin</h6>
                                                    </a>
                                                    <p>
                                                        <svg class="stroke-icon">
                                                            <use
                                                                href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#map-icon">
                                                            </use>
                                                        </svg>Texas
                                                    </p>
                                                </div>
                                        ...
                                        <li class="d-flex align-items-center justify-content-between gap-2">
                                            <div class="d-flex gap-2">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="/admin_assets/images/dashboard-1/user/02.png"
                                                        alt="" /></div>
                                                <div><a href="#">
                                                        <h6>Smith Lovell</h6>
                                                    </a>
                                        ...
                                        <li class="d-flex align-items-center justify-content-between gap-2">
                                            <div class="d-flex gap-2">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="/admin_assets/images/dashboard-1/user/03.png"
                                                        alt="" /></div>
                                                <div><a href="#">
                                                        <h6>Jones Brooks</h6>
                                                    </a>
                                        ...
                                        <li class="d-flex align-items-center justify-content-between gap-2">
                                            <div class="d-flex gap-2">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="/admin_assets/images/dashboard-1/user/04.png"
                                                        alt="" /></div>
                                                <div><a href="#">
                                                        <h6>Brown Acum</h6>
                                                    </a>
                                        ...
                                        <li class="d-flex align-items-center justify-content-between gap-2">
                                            <div class="d-flex gap-2">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="/admin_assets/images/dashboard-1/user/05.png"
                                                        alt="" /></div>
                                                <div><a href="#">
                                                        <h6>Evans Mayo</h6>
                                                    </a>
                                        ...
                                        <li class="d-flex align-items-center justify-content-between gap-2">
                                            <div class="d-flex gap-2">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="/admin_assets/images/dashboard-1/user/06.png"
                                                        alt="" /></div>
                                                <div><a href="#">
                                                        <h6>Wilson Pipes</h6>
                                                    </a>
                                        ...
                                        <li class="d-flex align-items-center justify-content-between gap-2">
                                            <div class="d-flex gap-2">
                                                <div class="flex-shrink-0 comman-round"><img
                                                        src="/admin_assets/images/dashboard-1/user/07.png"
                                                        alt="" /></div>
                                                <div><a href="#">
                                                        <h6>Alice Pindar</h6>
                                                    </a>
                                    ...
                                    <ul>
                                        <li class="d-flex gap-2">
                                            <div class="flex-shrink-0"><img class="img-fluid"
                                                    src="/admin_assets/images/dashboard-1/news-update/1.png"
                                                    alt="" /></div>
                                        ...
                                        <li class="d-flex gap-2">
                                            <div class="flex-shrink-0"><img class="img-fluid"
                                                    src="/admin_assets/images/dashboard-1/news-update/2.png"
                                                    alt="" /></div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                                        ...
                                        <li class="d-flex gap-2">
                                            <div class="flex-shrink-0"><img class="img-fluid"
                                                    src="/admin_assets/images/dashboard-1/news-update/3.png"
                                                    alt="" /></div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                                        ...
                                        <li class="d-flex gap-2">
                                            <div class="flex-shrink-0"><img class="img-fluid"
                                                    src="/admin_assets/images/dashboard-1/news-update/4.png"
                                                    alt="" /></div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                                        ...
                                        <li class="d-flex gap-2">
                                            <div class="flex-shrink-0"><img class="img-fluid"
                                                    src="/admin_assets/images/dashboard-1/news-update/5.png"
                                                    alt="" /></div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                                                    <h6>Business project research</h6>
                                                </a>
                                        ...
                                        <li class="d-flex gap-2">
                                            <div class="flex-shrink-0"><img class="img-fluid"
                                                    src="/admin_assets/images/dashboard-1/news-update/6.png"
                                                    alt="" /></div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                                        ...
                                        <li class="d-flex gap-2">
                                            <div class="flex-shrink-0"><img class="img-fluid"
                                                    src="/admin_assets/images/dashboard-1/news-update/7.png"
                                                    alt="" /></div>
                                            <div class="flex-grow-1"> <a href="private-chat.html">
                                                    <h6>Added new work</h6>
                                                </a>
                                ...
                                <div class="card-body total-invest">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-md-12 invest-content text-center">
                                            <svg class="stroke-icon">
                                                <use
                                                    href="https://admin.pixelstrap.net/admiro/assets/svg/icon-sprite.svg#chart-invest">
                                                </use>
                                            </svg>
                                        ...
                                        <table class="table display table-bordernone mt-0" id="manage-invoice"
                                                ...
                                                <tr>
                                                    <th>
                                                        <div class="form-check checkbox checkbox-solid-primary">
                                                            <input class="form-check-input" id="solid"
                                                                type="checkbox" />
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-check checkbox checkbox-solid-primary">
                                                            <input class="form-check-input" id="solid2"
                        ...
                        <div class="col-md-6">
                            <p class="float-end mb-0">Hand crafted &amp; made with
                                <svg class="svg-color footer-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/admiro/assets/svg/iconly-sprite.svg#heart">
                                    </use>
                                </svg>
                            </p>
                        </div>
