                            ...
                            <ul>
                                <li class="d-flex align-items-center gap-2">
                                    <div class="flex-shrink-0 bg-success"><img
                                            src="/admin_assets/images/dashboard-1/icon/checked.png" alt="" />
                                    </div>
                                    <div class="flex-grow-1"><a href="product-page.html">
                                ...
                                <li class="d-flex align-items-center gap-2">
                                    <div class="flex-shrink-0 bg-warning"><img
                                            src="/admin_assets/images/dashboard-1/icon/danger.png" alt="" />
                                    </div>
                                    <div class="flex-grow-1"><a href="product-page.html">
                                ...
                                <li class="d-flex align-items-center gap-2">
                                    <div class="flex-shrink-0 bg-danger"><img
                                            src="/admin_assets/images/dashboard-1/icon/cancel.png" alt="" />
                                    </div>
                                    <div class="flex-grow-1"><a href="product-page.html">
                        ...
                        <div class="card-body top-user pt-2">
                            <ul>
                                <li class="d-flex align-items-center justify-content-between gap-2">
                                    <div class="d-flex gap-2">
                                        <div class="flex-shrink-0 comman-round"><img
                                                src="/admin_assets/images/dashboard-1/user/01.png" alt="" />
                                        </div>
                                        <div><a href="#">
                                                <h6>Alice Goodwin</h6>
                                            </a>
                                ...
                                <li class="d-flex align-items-center justify-content-between gap-2">
                                    <div class="d-flex gap-2">
                                        <div class="flex-shrink-0 comman-round"><img
                                                src="/admin_assets/images/dashboard-1/user/02.png" alt="" />
                                        </div>
                                        <div><a href="#">
                                                <h6>Smith Lovell</h6>
                                            </a>
                                ...
                                <li class="d-flex align-items-center justify-content-between gap-2">
                                    <div class="d-flex gap-2">
                                        <div class="flex-shrink-0 comman-round"><img
                                                src="/admin_assets/images/dashboard-1/user/03.png" alt="" />
                                        </div>
                                        <div><a href="#">
                                                <h6>Jones Brooks</h6>
                                            </a>
                                ...
                                <li class="d-flex align-items-center justify-content-between gap-2">
                                    <div class="d-flex gap-2">
                                        <div class="flex-shrink-0 comman-round"><img
                                                src="/admin_assets/images/dashboard-1/user/04.png" alt="" />
                                        </div>
                                        <div><a href="#">
                                                <h6>Brown Acum</h6>
                                            </a>
                                ...
                                <li class="d-flex align-items-center justify-content-between gap-2">
                                    <div class="d-flex gap-2">
                                        <div class="flex-shrink-0 comman-round"><img
                                                src="/admin_assets/images/dashboard-1/user/05.png" alt="" />
                                        </div>
                                        <div><a href="#">
                                                <h6>Evans Mayo</h6>
                                            </a>
                                ...
                                <li class="d-flex align-items-center justify-content-between gap-2">
                                    <div class="d-flex gap-2">
                                        <div class="flex-shrink-0 comman-round"><img
                                                src="/admin_assets/images/dashboard-1/user/06.png" alt="" />
                                        </div>
                                        <div><a href="#">
                                                <h6>Wilson Pipes</h6>
                                            </a>
                                ...
                                <li class="d-flex align-items-center justify-content-between gap-2">
                                    <div class="d-flex gap-2">
                                        <div class="flex-shrink-0 comman-round"><img
                                                src="/admin_assets/images/dashboard-1/user/07.png" alt="" />
                                        </div>
                                        <div><a href="#">
                                                <h6>Alice Pindar</h6>
                                            </a>
                            ...
                            <ul>
                                <li class="d-flex gap-2">
                                    <div class="flex-shrink-0"><img class="img-fluid"
                                            src="/admin_assets/images/dashboard-1/news-update/1.png" alt="" />
                                    </div>
                                ...
                                <li class="d-flex gap-2">
                                    <div class="flex-shrink-0"><img class="img-fluid"
                                            src="/admin_assets/images/dashboard-1/news-update/2.png" alt="" />
                                    </div>
                                    <div class="flex-grow-1"> <a href="private-chat.html">
                                ...
                                <li class="d-flex gap-2">
                                    <div class="flex-shrink-0"><img class="img-fluid"
                                            src="/admin_assets/images/dashboard-1/news-update/3.png" alt="" />
                                    </div>
                                    <div class="flex-grow-1"> <a href="private-chat.html">
                                ...
                                <li class="d-flex gap-2">
                                    <div class="flex-shrink-0"><img class="img-fluid"
                                            src="/admin_assets/images/dashboard-1/news-update/4.png" alt="" />
                                    </div>
                                    <div class="flex-grow-1"> <a href="private-chat.html">
                                ...
                                <li class="d-flex gap-2">
                                    <div class="flex-shrink-0"><img class="img-fluid"
                                            src="/admin_assets/images/dashboard-1/news-update/5.png" alt="" />
                                    </div>
                                    <div class="flex-grow-1"> <a href="private-chat.html">
                                            <h6>Business project research</h6>
                                        </a>
                                ...
                                <li class="d-flex gap-2">
                                    <div class="flex-shrink-0"><img class="img-fluid"
                                            src="/admin_assets/images/dashboard-1/news-update/6.png" alt="" />
                                    </div>
                                    <div class="flex-grow-1"> <a href="private-chat.html">
                                ...
                                <li class="d-flex gap-2">
                                    <div class="flex-shrink-0"><img class="img-fluid"
                                            src="/admin_assets/images/dashboard-1/news-update/7.png" alt="" />
                                    </div>
                                    <div class="flex-grow-1"> <a href="private-chat.html">
                                            <h6>Added new work</h6>
                                        </a>
